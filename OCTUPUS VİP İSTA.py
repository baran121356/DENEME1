...
output = render('OCTOPS DEZZE', colors=['blue', 'green','yellow'], align='center')
print(F+'▬'*60)
print(output)
Op = "FOREX"
print(F+'▬'*60)
azooz=f" {F} Instagram Tool 2012-2011 🙈 ️ • "
print(azooz)
print(Z+'▬'*60)
def cls():
	os.system("clear")
...
tok = input(V+'Token ~> {}'.format(B,C,V,K))
print(K+'▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭')
print("\r")
iD = input(F+' ID ~> {}'.format(B,C,V,K))
os.system('clear')
def cookie(email):
...
def hunting(email):	
    ...
    'ig_sig_key_version': '4',
		...
		try:
			...
			name = None
		date = date_sc(Id)			
		requests.post(f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/yyyyyy3w/15&caption=*• ||*
""");hunt = ("""
...
def check_email(email):
	...
	bo = f'\x1b[38;5;{b}m'
	check+=1
	sys.stdout.write(f"\r   {bo}{C}Forex {bo}☠ ️{C}Hit : {F}{good_hot}  {C}Not Hunting : {R}{bad_ig}  {C}Secure : {X}{good_ig}  {C}{bo}check•{check}\r")
	sys.stdout.flush()
